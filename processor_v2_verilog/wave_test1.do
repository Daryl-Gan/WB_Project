...
add wave -noupdate -radix hexadecimal /multicycle_tb/DUT/Control/counter
add wave -noupdate /multicycle_tb/DUT/Control/StopFlag
add wave -noupdate -radix hexadecimal /multicycle_tb/DUT/Control/state
add wave -noupdate /multicycle_tb/DUT/Control/instr
TreeUpdate [SetDefaultTree]
WaveRestoreCursors {{Cursor 1} {2051721 ps} 0}
...
update
WaveRestoreZoom {2031249 ps} {2179521 ps}
